...
// Objects used in encoder indev group
static lv_obj_t *btn_menu;
static lv_obj_t *v_set_spinbox;
static lv_obj_t *i_set_spinbox;
...
static lv_obj_t* create_interface_bar() {
    ...
    lv_obj_t *if_bar = lv_obj_create(scr);

    // Buttons
    btn_menu = lv_btn_create(if_bar);
    ...
    lv_obj_t *btn_up = lv_btn_create(if_bar);
    ...
    lv_obj_t *btn_down = lv_btn_create(if_bar);
    ...
    lv_obj_t *btn_enter = lv_btn_create(if_bar);
    ...
    // Placeholder
    lv_obj_t *ph_cont = lv_obj_create(if_bar);
    ...
    // Power delivery
    lv_obj_t *pd_v_cont = lv_obj_create(if_bar);
    ...
    lv_obj_set_grid_dsc_array(if_bar, if_grid_col, if_grid_row);
...
static lv_obj_t* create_view_window() {
    ...
    lv_obj_t *view_window = lv_obj_create(scr);

    // voltage fields
    lv_obj_t *v_view = lv_obj_create(view_window);
    ...
    v_set_spinbox = lv_spinbox_create(v_set_cont);
    ...
    // Current fields
    lv_obj_t *i_view = lv_obj_create(view_window);
    ...
    i_set_spinbox = lv_spinbox_create(i_set_cont);
    ...
    // Power fields
    lv_obj_t *w_view = lv_obj_create(view_window);
    ...
    lv_obj_set_grid_dsc_array(view_window, view_grid_col, view_grid_row);
...
void display_start_app() {
    ...
    lv_obj_t *view_window = create_view_window();
    ...
    lv_obj_set_grid_cell(view_window, LV_GRID_ALIGN_STRETCH, 0, 1, LV_GRID_ALIGN_STRETCH, 0, 1);
